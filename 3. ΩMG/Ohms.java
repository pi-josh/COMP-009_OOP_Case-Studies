	...
	public class Ohms {
		...
		*/
		...
		public static String[] getThreeBands() {
            ...
            String bandColor = in.next().toLowerCase();

            	if (!isValidColor(bandColor, COLOR_CODES)) {
               		System.out.println("Invalid color: " + bandColor);
                	System.exit(1); // Terminate the program if an invalid color is entered
            	}

            bandsList[i] = bandColor;
        }
        return bandsList;
    }
